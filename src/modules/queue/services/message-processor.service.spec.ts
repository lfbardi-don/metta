...
describe('MessageProcessorService', () => {
    ...
    describe('processMessageBatch', () => {
        ...
        it('should process a batch of messages successfully', async () => {
            ...
            expect(persistenceService.updateIncomingMessageMetadata).toHaveBeenCalled();
            ...
            expect(chatwootService.setTypingStatus).toHaveBeenCalledWith('conv-1', false);
        });

        it('should handle errors and rethrow', async () => {
            mockWorkflowAIService.processMessage.mockRejectedValue(new Error('AI Error'));

            await expect(service.processMessageBatch('conv-1', mockMessages)).rejects.toThrow('AI Error');
